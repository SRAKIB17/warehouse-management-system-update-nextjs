...
const Messenger_whatsapp_media_social = ({ color = '#46C254',strokeWidth='0', strokeColor='currentColor', size = '64', ...rest }) => {
    return (
        <svg
...
export default Messenger_whatsapp_media_social;
