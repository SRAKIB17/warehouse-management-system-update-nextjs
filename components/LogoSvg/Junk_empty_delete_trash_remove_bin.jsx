...
const Junk_empty_delete_trash_remove_bin = ({ color = '#ff0000',strokeWidth='0.17', strokeColor='currentColor', size = '130', ...rest }) => {
    return (
        <svg
...
export default Junk_empty_delete_trash_remove_bin;
