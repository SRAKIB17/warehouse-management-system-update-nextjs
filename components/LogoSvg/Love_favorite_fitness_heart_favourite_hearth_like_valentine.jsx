...
const Love_favorite_fitness_heart_favourite_hearth_like_valentine = ({ color = '#ff8a8a',strokeWidth='0', strokeColor='currentColor', size = '364', ...rest }) => {
    return (
        <svg
...
export default Love_favorite_fitness_heart_favourite_hearth_like_valentine;
