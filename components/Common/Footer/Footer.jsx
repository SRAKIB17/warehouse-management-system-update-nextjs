...
const Footer = () => {
    return (
        <footer className="footer p-10 bg-[#164DB0] text-white">
        
            <div className="items-center grid-flow-col text-xl">
                ...
                <p> Ltd.<br />Providing reliable tech since 1992</p>
            </div>
            <div>
                <span className="footer-title">Social</span>
                <div className="grid grid-flow-col gap-4 items-center">
                    <a href="">
                        <Facebook_oval size='40' color='white'/>
                    </a>
                    <a href="">
                        <Youtube size='48' color='white'/>
                    </a>
                    <a href="">
                        <Messenger_whatsapp_media_social size='40' color='white' />
                    </a>
                </div>
            </div>
        </footer>
